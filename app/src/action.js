(function (root) {
  ...
  var PerformableAction = {
     ...
     * Instead of a function `this.canPerformAction` can be set to a boolean value if the check should always be true
     * or false.
     *
  ...
  var ResolvableAction = {
     ...
     * @param {Object} source - The source object performing the action on this target.
     * @param {Object} [settings] - Settings for the action.
     * @return {bool} `true` if the action was successfully resolved.
     */
    resolveAction: true
  };
